...
const getWalletDetails = async (req, res) => {
    try {
        const AdminWallet = await adminWallet.findOne()
            .populate('paymentHistory', 'bookingId amount status'); // Fixed field name
...
export { initializeWallet, getWalletDetails, updateWalletOnBooking, handleOrderCancellation };